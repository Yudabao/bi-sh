                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                if (data.data) {
                                    ...
                                    //     utils.show_num('.num2', data.data[1].number ? data.data[1].number : '000000');
                                    //     $('.num1').attr({'value': data.data[0].number ? data.data[0].number : '000000'});
                                    //     $('.num2').attr({'value': data.data[1].number ? data.data[1].number : '000000'});
                                    // } else {
                                    //     $('.num1').attr({'value': parseInt($('.num1').attr('value')) + Math.round(Math.random() * 10)});
                                    //     $('.num2').attr({'value': parseInt($('.num2').attr('value')) + Math.round(Math.random() * 20)});
