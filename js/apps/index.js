(function (win, $) {
    var utils = {
        ...
        renderPageSize: function () {
            ...
            $('#roomChart').css({width: winW * 0.216, height: winH * 0.315});
            $('.room-bg').css({
                width: winW * 0.216 * 0.102,
                height: winH * 0.315 * 0.149,
                left: winW * 0.216 * 0.5,
                top: winH * 0.315 * 0.5,
                marginLeft: -winW * 0.216 * 0.102 * 0.5 + Math.sqrt(5),
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    [['上海', SHData]].forEach(function (item, i) {
                        ...
                        item[1].forEach(function (dataItem, i) {
                            var matchGeo = utils.geoCoordMap[dataItem[1].name];

                            if (matchGeo)
                                cityMap.push({
                                    name: dataItem[1].name,
                                    value: matchGeo.concat([dataItem[1].value])
                                });
                        });

                        finalData.data = cityMap;

                        series.push(finalData);
                    });
                    option = {
                    ...
                    setInterval(function () {
                        ...
                        $.ajax({
                            ...
                            data: {
                                ...
                                'Sites': '0000000033,0000000066,0000000067,0000000068,0000000069,0000000071,0000000070,0000000063,0000000045,0000000072,0000000026,0000000073,0000000224,0000000076,0000000084,0000000087,0000000088,0000000090,0000000052,0000000053,0000000095,0000000107,0000000111,0000000116,0000000101,0000000012,0000000112,0000000109,0000000117,0000000114,0000000115,0000000118,0000000011,0000000097,0000000108,0000000144,0000000119,0000000121,0000000120,0000000190,0000000309,0000000152,0000000151,0000000167,0000000204,0000000145,0000000210,0000000211,0000000212,0000000217,0000000215,0000000214,0000000213,0000000218,0000000219,0000000220,0000000255,0000000225,0000000209,0000000027,0000000273,0000000277,0000000279,0000000280,0000000281,0000000079,0000000274,0000000284,0000000289,0000000291,0000000282,0000000226,0000000227,0000000228,0000000216,0000000290,0000000272,0000000308,0000000296,0000000297,0000000298,0000000299,0000000020,0000000311,0000000312,0000000143,0000000316,0000000325,0000000328,0000000331,0000000335,0000000337,0000000315,0000000339,0000000340,0000000341,0000000342,0000000343,0000000344,0000000338,0000000369,0000000370,0000000372,0000000014,0000000373,0000000374,0000000377'
                            },
                            cache: false,
                            error: function (data) {
                            },
                            success: function (data) {
                                if (data.data) {
                                    ...
                                    utils.show_num('.num2', parseInt(parseFloat(temp[1].number)) ? parseInt(parseFloat(temp[1].number)) + 1000000 : '0000000');
                                    // if (!$('.num1').attr('value')) {
                                    //     utils.show_num('.num1', data.data[0].number ? data.data[0].number : '000000');
                                    //     utils.show_num('.num2', data.data[1].number ? data.data[1].number + 1000000  : '000000');
                                    //     $('.num1').attr({'value': data.data[0].number ? data.data[0].number : '000000'});
                                    //     $('.num2').attr({'value': data.data[1].number ? data.data[1].number + 1000000 : '000000'});
                                    // } else {
                                    ...
                                    // }
                                    // data.data[2].list.push({name: SHData[Math.round(Math.random() * 19)][1].name});
                                    ...
                                    temp[2].list.forEach(function (dataItem) {
                                        var cityGeo = utils.geoCoordMap[dataItem.name.replace('市', '')]

                                        if (cityGeo)
                                            seriesInnerData.push({
                                                name: dataItem.name.replace('市', ''),
                                                value: cityGeo.concat([utils.getValue(SHData, dataItem.name)])
                                            })
                                    })

                                    seriesData.data = seriesInnerData;
        ...
        roomNumber: function () {
            ...
            $.ajax({
                ...
                success: function (data, textStatus, jqXHR) {
                    if (data.errorCode == 0) {
                        var seriesData1 = [{
                            value: data.data[0].id == '1051002' ? data.data[0].number : data.data[1].number,
                            name: '分散式',
                            selected: true,
                            label: {
                                normal: {
                            ...
                            value: data.data[0].id == '1051001' ? data.data[0].number : data.data[1].number,
                            name: '集中式',
                            itemStyle: {
                                normal: {
                                    color: '#00cf17'
